...
import choixVoyage.model.Client;
import choixVoyage.model.Reservation;


public class TouristGUIReponse extends javax.swing.JFrame {

 
    TouristAgent clientAgent;
    Reservation curentReservation;

    public TouristGUIReponse(TouristAgent clientAgent, Reservation reservationPropose) {
    ...
    private void btnConfirmerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmerActionPerformed
        ...
        if (!EstVide2()) {
            ...
            JOptionPane.showMessageDialog(this, "Error", "Fill all blanks! ", JOptionPane.INFORMATION_MESSAGE);
        }
